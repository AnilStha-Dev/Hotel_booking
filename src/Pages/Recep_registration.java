 ...
 * @author raaz4
 */
public class Recep_registration implements ActionListener {
...
//panel2 registration lbls
    ...
    public void RegistrationForm() {
        frame = new JFrame();
        frame.setTitle("Luton Hotel - Reception Registration");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btn_register) {
            ...
            if (re.isEmail(txt_email.getText()) == true && txt_address.getText().length() > 0 && re.isAlphabets(txt_name.getText()) == true && txt_name.getText().length() > 0 && re.isInteger(txt_phone.getText()) == true && txt_phone.getText().length() == 10 && psd.length() > 0) {
                ...
                Rep_searchCustomer reception = new Rep_searchCustomer(txt_name.getText(), txt_address.getText(), Long.parseLong(txt_phone.getText()), txt_email.getText(), psd);
                System.out.println(reception);

                ReceptionJDBC obj = new ReceptionJDBC();
                obj.insert(reception);
                JOptionPane.showMessageDialog(null, " Registration Successfull ");
                
            } else {
                String message = " !!! Registration Unsucessfull !!! ";
                JOptionPane.showMessageDialog(null, message, "Invalid", JOptionPane.ERROR_MESSAGE);
            }
